...
function getAngleAt(x,  y){
  return getNoiseAt(x,y)*PI*55;
}

function getNoiseAt(y,  x){
  var ns = 0.0001;
...
function P(){
	...
	this.l = 	maxm/this.m;
	this.hue = map(this.m,minm,maxm,.200,255);
	this.sat = random(.05,1);
