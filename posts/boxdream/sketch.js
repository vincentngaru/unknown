...
for(var y = -w/2; y < w/2; y+= scl){
      //for every box on the plane: we'll have to find how tall to make it and what color to give it
        ...
        var h = map(d*td,0,1,0,512)%120; //h (hue) is found by multiplying d and td.
        ...
        fill(h, 220, 255); //fill the boxes with a color of the hue, desaturate it a tiny bit (150) and give it full brightness (255)
